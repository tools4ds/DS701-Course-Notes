...
1. Pick $K$ cluster centers $\{c_1, \dots, c_K\}$.  
    - These can be randomly chosen datapoints, or by some other method such as
...
Let's see this in practice with well separated clusters and also look at the WCSS:
...
* Importance of initialization and cluster numberr
* Feature scaling
* Example application
