...
:::: {.incremental}
- A1 lecture - Tu,Th 9:30am - 10:45am, 665 Comm Ave CDS B62, Prof Thomas Gardos
- A1 discussion - We 12:20pm - 1:10pm, 750 Comm Ave EPC 205
- C1 lecture - Mo,We 4:40pm - 5:55pm, 595 Comm Ave HAR 324, Prof Scott Ladenheim
- C2 discussion - Fr 10:00am - 11:00am 685-725 Comm Ave CAS 313
::::
...
The slides used in the lecture are [Quarto](https://quarto.org/) RevealJS presentations. You can run the code demonstrated in lecture on your own. 
...
You should already be signed up for Gradescope (if not, enroll using code TBD).

You can add yourself to Piazza if you are not already enrolled.
...
> NOTE: IMPORTANT: Late assignments WILL NOT be accepted. However, you may submit one homework up to 3 days late. You must email TBD before the deadline if you intend to submit a homework late.
