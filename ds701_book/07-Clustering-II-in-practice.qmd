...
Find the centroids of the distance matrix.
...
One tool we may be able to use in some settings is __external__ information
about the data.

In particular, we may have knowledge from some other source about the nature of
the clusters in the data.

In that case, what we need is a way to compare a proposed clustering with some
externally-known, "ground truth" clustering.

The Rand Index is a __similarity measure__ for __clusterings.__   We can use it
