...
Clustering is a technique that groups unlabeled data together based upon their similarties (or differences). We cover the following topics in clustering:
...
Dimensionality reduction is a technique that compresses high-dimensional data into lower dimensional data with minimal information loss. We cover dimensionality reduction when discussing the [Singular Value Decompositin](11-Dimensionality-Reduction-SVD-II.qmd).
