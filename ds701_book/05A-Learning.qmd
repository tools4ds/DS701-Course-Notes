...
- $k$-means clustering, see @sec-kmeans and @sec-clustering-in-practice,
- hierarchical clustering, see @sec-hierarchical-clustering,
- Gaussian mixing, see @sec-gaussian-mixture-models.

### Dimensionality reduction

Dimensionality reduction is a technique that compresses high-dimensional data into lower dimensional data with minimal information loss. We cover dimensionality reduction in @sec-low-rank-svd and @sec-pca-svd.
...
Regression models in machine learning are used to predict continuous values based on the input features. We cover linear regression models in @sec-linear-regression and logistic regression in @sec-log-regression.
...
- decision tress and random forests, see @sec-decision-trees,
- $k$-nearest neighbors, see @sec-knn,
- naive Bayes and support vector machines, see @sec-NB-svm.
