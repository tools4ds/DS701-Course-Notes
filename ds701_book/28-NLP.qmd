...
- **1950s-1970s**: Rule-based systems (Turing Test, formal grammars)
- **1980s-2000s**: Statistical methods (n-grams, machine learning)
- **2006-2017**: Deep learning (RNNs, LSTMs, attention mechanisms)
- **2017-Present**: Transformers and LLMs (BERT, GPT, modern NLP)
