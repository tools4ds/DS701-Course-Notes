...
we reached a node of pure class but there are reasons to stop splitting even without pure classes, which we'll see later.
...
From Intro to Data Mining[@Tan2018, p. 127]:
