...
::: {layout-ncol=3}
![AI Tutor Sign In](figs/ai-tutor-signin.png){width="200px"}

![AI Tutor Start](figs/ai-tutor-start.png){width="200px"}

![AI Tutor Chat Interface](figs/ai-tutor-chat-interface.png){width="600px"}
:::

* Try it: [https://tools4ds-ai-tutor.hf.space](https://tools4ds-ai-tutor.hf.space).
* All DS701 Students are registered to use it
* It is open source hosted at [https://github.com/tools4ds/ds701-tutor](https://github.com/tools4ds/ds701-tutor)
