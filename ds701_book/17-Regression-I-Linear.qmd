...
# Solve for beta
beta = np.linalg.solve(R, Q.T @ yquad)
```
...
# Solve for beta
beta = np.linalg.solve(R, Q.T @ ylog)
```
...
counter-intuitive.  The reason is explained [here(https://stats.stackexchange.com/questions/26176/removal-of-statistically-significant-intercept-term-increases-r2-in-linear-mo/26205#26205)] -- but amounts to the fact that
