...
There are many other clustering algorithms as illustrated below from Scikit-learn
[Clustering](https://scikit-learn.org/stable/modules/clustering.html#dbscan).

You can see the strengths and weaknesses for various kinds of data distributions.


![](figs/L08-cluster-plot-comparison.png){width="100%" fig-align="center"}

## DBSCAN -- Density Based Scanning

We'll talk about one more: [DBSCAN](https://scikit-learn.org/stable/modules/clustering.html#dbscan).
