...
meausre, the more dissimilar the objects are.
...
For vectors $\mathbf{u}, \mathbf{v}\in\mathbf{R}^{n}$ and scalar $a\in\mathbb{R}$. 
The vector function $p(\mathbf{v})$ is called a __norm__ if
