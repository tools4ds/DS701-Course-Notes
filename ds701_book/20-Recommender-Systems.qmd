...
Notice that there are 6,204,445,920 __potential__ reviews, but we only have 
1,697,533 __actual__ reviews.
...
![](figs/L20-u-u-cf-4.png){width="60%" fig-align="center"}
...
How can we estimate the $\alpha\textnormal{s}$, the $\beta\textnormal{s}$, and the $\mu\textnormal{s}$?
...
![](figs/L10-Movie-Latent-Space.png){width="60%" fig-align="center"}
...
![](figs/L20-mf-1.png){width="60%" fig-align="center"}

Now we want the product of the two matrices on the right to be as close as 
possible __to the known values__ of the ratings matrix.
...
# We are pulling these hyperparameters out of the air;
