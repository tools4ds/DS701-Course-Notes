...
plt = aapl_close_px.plot(label='AAPL', figsize=(8,3), ylabel='Price', title='AAPL Stock Price')
```
...
We can also look at the autocorrelation plot to see if there are any
...
## Demonstration of stationarity tests
...
TODO: Add example of ARIMA/SARIMA using Python from other notebook.
