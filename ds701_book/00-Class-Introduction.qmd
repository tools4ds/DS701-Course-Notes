...
* **Office Hours:** Tuesdays 3:30 pm -- 4:45 pm
...
![](figs/people/atul.jpg){width=200px}
...
![](figs/people/samritha.jpg){width=200px}
...
**Carlos Fernando Garcia Padilla**
...
1. methods for structured (e.g. tabular) data
::::
::::
...
:::: {.incremental}
- Introductory material (_probability and linear algebra refreshers, pandas and scikit-learn_)
- Clustering techniques (_k-means, hierarchical clustering, gaussian mixture models_)
...
2. Fork and clone the [repository]({{< var github_url >}}) and run the Jupyter notebooks version of the lectures locally.
...
* The course notes are written in [Quarto](https://quarto.org/) markdown.
* The slides are [Quarto RevealJS](https://quarto.org/docs/presentations/) presentations. 
* Setup instructions are on the repo [README]({{< var github_url >}}/blob/main/README.md). 
...
1. [Kaggle](https://www.kaggle.com/) for the midterm challenge
...
We will use [Python](https://www.python.org/) as the language for teaching and
for assignments that require coding. 

We have a [chapter](01-Intro-to-Python.qmd) on installing python and a brief
recap of some python fundamentals.

If you are don't feel proficient in python, you should review the chapter, or
even better, complete a more comprehensive on-line course on python.
...
## Project Grading Details {.scrollable}
...
**Participation** is an important part of the class and intended to keep you
engaged as well as practice "thinking on your feet". It will be a combination
of volunteered answers and randomly calling students.

**In-Class Activities** will be where you work in small groups on challenges that
reinforce your understanding of the material in the lecture.
...
> See team assignment in [Gradescope]({{< var gradescope_url >}}).
...
GenAI is a powerful tool that can help you learn and be more productive and
undoubtedly will be part of your workflow going forward. We will use it!

But, would you...

::: {#fig-robots layout-ncol=2}

![...build strength by having a robot left weights for you?](figs/robot_weightlifting.png){.fragment width=300px #fig-robot-weightlifting}

![...increase your fitness by having a robot jog for you?](figs/robot_jogging.png){.fragment width=300px #fig-robot-jogging}

Via ChatGPT -- _And yes, I'm aware of the irony._
:::
...
And fill out the [intro survey]({{< var intro_survey_form_url >}}) and indicate so in [Gradescope]({{< var gradescope_url >}}).