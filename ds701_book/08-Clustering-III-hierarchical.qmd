...
First, a hierarchical clustering encodes many __different__ clusterings.  That is,
...
The second advantage is that the dendrogram may itself correspond to a meaningful
structure, for example, a taxonomy.

![](./figs/L08-animal-taxonomy.jpg){width="600px"}

The third advantage is that many hierarchical clustering methods can be performed
...
![](./figs/L08-hierarchical-criteria.png){width="600px"}
